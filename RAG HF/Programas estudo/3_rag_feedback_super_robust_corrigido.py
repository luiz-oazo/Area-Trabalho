...
Compatível com arquivos do 1_rag_trainer_corrigido.py
"""
...
class SuperRobustRAG:
    ...
    def generate_answer(self, question, context_docs):
        ...
        try:
            ...
            for doc in sorted_docs[:3]:
                ...
                text = doc['text'][:300]  # Limitar tamanho
                context_parts.append(f"De '{title}': {text}")

            context = "\n\n".join(context_parts)

            # Resposta simples baseada no contexto
            answer = f"Com base nos documentos encontrados sobre '{question}':\n\n"
            answer += context[:800] + "..."
    ...
    def interactive_mode(self):
        ...
        print("Seus dados NUNCA serão perdidos!")
